...
ClearBellDesc:
	db   "Maakt een fijn" ; "Makes a gentle"
	next "geluid.@" ; "ringing.@"
...
GSBallDesc:
	db   "De mysterieuze" ; "The mysterious"
	next "BAL.@" ; "BALL.@"

BlueCardDesc:
	db   "Kaart om punten" ; "Card to save"
...
EggTicketDesc:
	db   "Gebruik in Golden-" ; "May use at Golden-"
	next "rod-ruilhoek.@" ; "rod trade corner.@"
