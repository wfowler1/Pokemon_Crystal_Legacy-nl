...
CinnabarIslandBlueText:
	...
	para "Ik zorg voor één" ; "I'm looking"
	line "van RED's legen-" ; "after one of RED's"

	para "darische vogels," ; "legendary birds,"
	line "bereid je dus maar" ; "so you better"
	
	para "voor op een echt" ; "come ready for"
	line "gevecht." ; a real fight."

	para "Bezoek me in" ; "Come visit me"
	line "VIRIDIAN." ; "in VIRIDIAN."
